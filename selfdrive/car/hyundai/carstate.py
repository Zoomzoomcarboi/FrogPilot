...
class CarState(CarStateBase):
  ...
  def update_canfd(self, cp, cp_cam, frogpilot_toggles):
    ...
    if self.CP.openpilotLongitudinalControl:
      ...
      # REMOVED: All enhanced Ioniq 6 cruise state management for CAN-FD
      # Let the standard FrogPilot HDA2 logic handle cruise state properly
    else:
  ...
  def get_cam_can_parser_canfd(CP, FPCP):
    ...
    if CP.flags & HyundaiFlags.CANFD_HDA2:
      ...
      # CRITICAL: For HDA2 longitudinal, SCC_CONTROL MUST be on camera bus
    ...
    # REMOVED: All references to non-existent custom camera messages
    # No more "IONIQ6_CAM_LONG", "SCC13", "SCC14" or other fake messages
