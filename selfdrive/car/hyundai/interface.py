...
class CarInterface(CarInterfaceBase):
  ...
  def init(CP, logcan, sendcan):
    # Skip radar disable for cars with CANFD_NO_RADAR_DISABLE flag (like Ioniq 6)
    # These cars don't need radar disable for longitudinal control to work
    if CP.openpilotLongitudinalControl and not (CP.flags & HyundaiFlags.CANFD_CAMERA_SCC.value) and not (CP.flags & HyundaiFlags.CANFD_NO_RADAR_DISABLE.value):
      addr, bus = 0x7d0, 0
