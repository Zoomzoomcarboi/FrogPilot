...
# =======================
# HYUNDAI COMM CTRL BRUTE TEST LOOP with SecurityAccess + Seed Logging (fully integrated)
# =======================
...
if _HyundaiInterface is not None:
  class HyundaiInterface(_HyundaiInterface):
    def __init__(self, CP, CarController, CarState):
      ...
      # instantiate tester with panda uds send function
      try:
