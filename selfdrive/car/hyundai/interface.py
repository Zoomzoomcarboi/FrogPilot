  ...
  def _get_params(ret, candidate, fingerprint, car_fw, experimental_long, docs, frogpilot_toggles):
    ...
    if candidate in CANFD_CAR:
      ...
      if candidate == CAR.HYUNDAI_IONIQ_6:
        ...
        if (has_hda2 and 
          ...
          # FORCE camera SCC mode for HDA2 (critical for proper operation)
          ret.flags |= HyundaiFlags.CANFD_CAMERA_SCC.value
    ...
    if candidate in CANFD_CAR:
      ...
      if ret.flags & HyundaiFlags.CANFD_HDA2:
        ...
        # CRITICAL: Only add longitudinal flags with extreme caution
    ...
    # FIXED: Only set standard longitudinal flag for non-HDA2 cars to avoid conflicts
    if (ret.openpilotLongitudinalControl and 
        not (ret.flags & HyundaiFlags.CANFD_HDA2) and
        candidate != CAR.HYUNDAI_IONIQ_6):
