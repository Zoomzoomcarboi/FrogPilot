...
class HyundaiFlags(IntFlag):
  ...
  # Add new flag for Ioniq 6 longitudinal support
  IONIQ_6_LONG = 2 ** 24
...
class CAR(Platforms):
  ...
  # Modified Ioniq 6 configuration to support longitudinal control
  HYUNDAI_IONIQ_6 = HyundaiCanFDPlatformConfig(
    [HyundaiCarDocs("Hyundai Ioniq 6 (with HDA II) 2023-24", "Highway Driving Assist II", car_parts=CarParts.common([CarHarness.hyundai_p]))],
    HYUNDAI_IONIQ_5.specs,
    flags=HyundaiFlags.EV | HyundaiFlags.CANFD_NO_RADAR_DISABLE | HyundaiFlags.IONIQ_6_LONG,
  )
...
# Add Ioniq 6 longitudinal support cars
IONIQ_6_LONGITUDINAL_CAR = CAR.with_flags(HyundaiFlags.IONIQ_6_LONG)
